...
const MainApp = {
    ...
    initAnimations() {
        ...
        document.querySelectorAll('.reveal').forEach(el => {
            if (el.closest('.hero') || el.closest('.premium-hero') || el.closest('.about-premium-hero') || el.closest('.dest-hero')) {
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.getElementById('tours-slider') || document.querySelector('.hero') || document.querySelector('.about-premium-hero') || document.querySelector('.premium-hero') || document.querySelector('.dest-hero')) {
        MainApp.start();
    ...
    // UNIVERSAL FAILSAFE: Always hide preloader after 800ms max to prevent infinite loading screens on secondary pages
    setTimeout(() => {
